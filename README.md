# LandNFT: Virtual Real Estate Platform for the Metaverse
...
To deploy and interact with **LandNFT**, you’ll need the following tools:
...
We welcome contributions to **LandNFT**! To contribute:
